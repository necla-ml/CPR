    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            try: model_without_ddp.load_state_dict(state_dict)
                ...
                neq_load_customized(model_without_ddp, state_dict, verbose=False)
        ...
        if os.path.isfile(args.pretrain):
            ...
            try: model_without_ddp.load_state_dict(state_dict)
            except: neq_load_customized(model_without_ddp, state_dict, verbose=False)
...
def set_path(args):
    if args.resume: exp_path = os.path.dirname(os.path.dirname(args.resume))
        ...
        exp_path = 'ckpt/log-{args.prefix}/{args.name_prefix}{args.model}_k{args.moco_k}_{args.dataset}-{args.img_dim}_{args.net}_\
