...
def main_kinetics400(v_root, frame_root, flow_root):
    ...
    for basename in ['train_256', 'val_256']:
        ...
        for i, j in tqdm(enumerate(v_act_root), total=len(v_act_root)):
            ...
            Parallel(n_jobs=16)(delayed(extract_ff_opencv)\
...
if __name__ == '__main__':
    ...
    main_HMDB51(v_root='/zdata/projects/shared/datasets/hmdb/videos',
                frame_root='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/hmdb51/frame',
                flow_root='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/hmdb51/flow')

    # main_kinetics400(v_root='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/kinetics400/video',
    #             frame_root='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/kinetics400/frame',
    #             flow_root='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/kinetics400/flow')