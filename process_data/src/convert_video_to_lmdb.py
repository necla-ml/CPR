...
def put_action(action_path, txn, get_video_id):
    ...
    array_list = [get_array(vp) for vp in tqdm(video_list, total=len(video_list))]
...
def make_dataset_lmdb(dataset_path, filename):
    ...
    db = lmdb.open(lmdb_path, subdir=isdir,
                   map_size=int(5e12), readonly=False,
...
if __name__ == '__main__':
    ...
    make_dataset_lmdb(dataset_path='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/hmdb51/frame',
                      filename='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/hmdb51/lmdb/frame/hmdb51_frame.lmdb')
    ...
    # make_dataset_lmdb(dataset_path='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/kinetics400/frame/train_256',
    #                   filename='/zdata/projects/shared/datasets/kinetics400/videos/kinetics400_256x256/kinetics400/lmdb/k400_frame_train.lmdb')
