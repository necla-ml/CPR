...
lmdb_root = '/home/mli/chwu/CPR/data'
...
class KineticsLMDB_2CLIP(object):
    def __init__(self, root, db_path, filename,
        ...
        with self.env.begin(write=False) as txn:
            ...
            if not self.is_flow: self.vlen_list = msgpack.loads(txn.get(b'__vlen__'))
...
class K400_LMDB_2CLIP(KineticsLMDB_2CLIP):
    def __init__(self, root='%s/../process_data/data/k400' % os.path.dirname(os.path.abspath(__file__)),
                 db_path=os.path.join('/home/mli/chwu/CoCLR/data', 'kinetics400-256/frame_full/lmdb/'),
                 filename='k400_frame',
                 **kwargs):
...
class K400_Flow_LMDB_2CLIP(KineticsLMDB_2CLIP):
    def __init__(self, root='%s/../process_data/data/k400' % os.path.dirname(os.path.abspath(__file__)),
                 db_path=os.path.join('/home/mli/chwu/CoCLR/data', 'kinetics400-256/tvl1_flow/lmdb/'),
                 filename='k400_flow',
                 **kwargs):
...
class K400_2STREAM_LMDB_2CLIP(Kinetics_2STREAM_LMDB_2CLIP):
    def __init__(self, root='%s/../process_data/data/k400' % os.path.dirname(os.path.abspath(__file__)),
                 db_path_flow=os.path.join('/home/mli/chwu/CoCLR/data', 'kinetics400-256/tvl1_flow/lmdb/'),
                 db_path_rgb=os.path.join('/home/mli/chwu/CoCLR/data', 'kinetics400-256/frame_full/lmdb/'),
                 filename_flow='k400_flow',
